...
```bash
yarn add typesense-docsearch.js@3
# or
npm install typesense-docsearch.js@3
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/typesense-docsearch.js@3"></script>
```
...
```bash
yarn add typesense-docsearch-react@3
# or
npm install typesense-docsearch-react@3
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/typesense-docsearch-react@3"></script>
```
