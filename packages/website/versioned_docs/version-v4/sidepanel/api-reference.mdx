...
:::warning
This prop only exists in the React based versions of Sidepanel. If you are using the `typesense-docsearch-sidepanel-js` package, use the `container` option instead.
:::
