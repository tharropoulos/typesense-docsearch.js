...
```bash
npm install typesense-docsearch-react@^5 typesense-docsearch-css@^5
```
...
```bash
yarn add typesense-docsearch-react@^5 typesense-docsearch-css@^5
```
...
```bash
pnpm add typesense-docsearch-react@^5 typesense-docsearch-css@^5
```
...
```bash
bun add typesense-docsearch-react@^5 typesense-docsearch-css@^5
```
...
```bash
npm install typesense-docsearch.js@^5 typesense-docsearch-css@^5
```
...
```bash
yarn add typesense-docsearch.js@^5 typesense-docsearch-css@^5
```
...
```bash
pnpm add typesense-docsearch.js@^5 typesense-docsearch-css@^5
```
...
```bash
bun add typesense-docsearch.js@^5 typesense-docsearch-css@^5
```
...
If you use the Composable API or Sidepanel, also upgrade `typesense-docsearch-core@^5`, `typesense-docsearch-modal@^5`, `typesense-docsearch-sidepanel@^5`, or `typesense-docsearch-sidepanel-js@^5`.
...
-<script src="https://cdn.jsdelivr.net/npm/typesense-docsearch.js@4"></script>
...
The full stylesheet remains available from `typesense-docsearch-css` and the CDN `dist/style.css` file:
...
`typesense-docsearch.js` now defines an exports map. Replace unsupported deep imports with `typesense-docsearch.js` or `typesense-docsearch.js/docsearch`. Continue to use documented React subpaths such as `typesense-docsearch-react/button`, `/modal`, `/sidepanel`, and `/version`; their generated file names changed, but the package subpaths remain the public API.
