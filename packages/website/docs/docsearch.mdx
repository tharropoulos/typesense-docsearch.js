...
If your docs site is powered by Docusaurus, use [`typesense-docsearch-docusaurus-adapter`](/docs/docusaurus-adapter) for the latest DocSearch features (including new Ask AI capabilities such as sidepanel support), while keeping `@docusaurus/preset-classic`.
...
```bash
yarn add typesense-docsearch.js@4
# or with npm
npm install typesense-docsearch.js@4
```
...
```bash
yarn add typesense-docsearch-react@4
# or
npm install typesense-docsearch-react@4
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/typesense-docsearch-react@4"></script>
```
