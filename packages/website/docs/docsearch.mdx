...
- Use [`typesense-docsearch.js`](/docs/packages/js/getting-started) for a JavaScript application.
- Use [`typesense-docsearch-react`](/docs/packages/react/getting-started) for a React application.
