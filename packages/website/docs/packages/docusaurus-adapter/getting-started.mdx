...
Use `typesense-docsearch-docusaurus-adapter` to add keyword search, a search results page, Ask AI, and an Ask AI Sidepanel to Docusaurus.
...
Install `typesense-docsearch-docusaurus-adapter@^5`:
