...
description: API reference for typesense-docsearch-modal v5.
---
...
| --- | --- | --- |
| `typesense-docsearch-modal` | `DocSearchButton`, `DocSearchModal`, `DocSearchAskAiModal` | `DocSearchButtonProps`, `DocSearchModalProps`, `DocSearchAskAiModalProps` |
