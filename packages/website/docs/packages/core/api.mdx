...
description: API reference for typesense-docsearch-core v5.
...
The root `typesense-docsearch-core` entry exports:
...
| Import path | Exports |
| --- | --- |
| `typesense-docsearch-core/useDocSearchKeyboardEvents` | `useDocSearchKeyboardEvents`, `UseDocSearchKeyboardEventsProps` |
| `typesense-docsearch-core/useKeyboardShortcuts` | `useKeyboardShortcuts`, `DEFAULT_KEYBOARD_SHORTCUTS`, shortcut types |
| `typesense-docsearch-core/useTheme` | `useTheme`, `DocSearchTheme`, `UseThemeProps` |
