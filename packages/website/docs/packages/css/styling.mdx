...
`typesense-docsearch-css` contains the styles for the search button, modal, and Sidepanel.
...
```bash
npm install typesense-docsearch-css@^5
```
...
```bash
yarn add typesense-docsearch-css@^5
```
...
```bash
pnpm add typesense-docsearch-css@^5
```
...
```bash
bun add typesense-docsearch-css@^5
```
