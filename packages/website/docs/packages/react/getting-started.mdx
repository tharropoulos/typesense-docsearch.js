...
`typesense-docsearch-react` exports separate components for keyword search and Ask AI. Choose the component that matches your application.
...
import { DocSearchAI, type DocSearchRef } from 'typesense-docsearch-react';
