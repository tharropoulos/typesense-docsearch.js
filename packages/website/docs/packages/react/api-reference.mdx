...
description: Reference for the components, props, ref, and exports in typesense-docsearch-react 5.
---
...
| Import | Export |
| --- | --- |
| `typesense-docsearch-react/askaiModal` | `DocSearchAskAiModal` |
| `typesense-docsearch-react/button` | `DocSearchButton` |
| `typesense-docsearch-react/docsearch` | `DocSearch` - Search only |
| `typesense-docsearch-react/docsearchAi` | `DocSearchAI` and AI types |
| `typesense-docsearch-react/modal` | `DocSearchModal` |
| `typesense-docsearch-react/sidepanel` | `DocSearchSidepanel` and Sidepanel components |
| `typesense-docsearch-react/useDocSearchKeyboardEvents` | `useDocSearchKeyboardEvents` |
| `typesense-docsearch-react/useTheme` | `useTheme` |
| `typesense-docsearch-react/version` | `version` |
...
Import `typesense-docsearch-css` for the complete modal stylesheet. The React package also exports `typesense-docsearch-react/style` and split `style/variables`, `style/button`, `style/modal`, `style/askai`, and `style/sidepanel` entries for component-level builds. See [Styling](/docs/packages/css/styling).
