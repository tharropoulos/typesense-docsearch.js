...
Use `typesense-docsearch.js` to render DocSearch into an HTML element. The default entry includes keyword search and Ask AI. A separate entry includes keyword search only.
...
/>
<script src="https://cdn.jsdelivr.net/npm/typesense-docsearch.js@^5/dist/umd/index.js"></script>
<script>
  window.docsearch({
    container: '#docsearch',
    appId: 'YOUR_APP_ID',
