...
If you use Docusaurus, install and configure `typesense-docsearch-docusaurus-adapter` to get the latest DocSearch features on your current Docusaurus version.
...
```bash
yarn add typesense-docsearch-docusaurus-adapter
# or
