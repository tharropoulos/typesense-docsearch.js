...
```bash
npm install typesense-docsearch-core@^5 typesense-docsearch-modal@^5 typesense-docsearch-sidepanel@^5 typesense-docsearch-css@^5
```
...
```bash
yarn add typesense-docsearch-core@^5 typesense-docsearch-modal@^5 typesense-docsearch-sidepanel@^5 typesense-docsearch-css@^5
```
...
```bash
pnpm add typesense-docsearch-core@^5 typesense-docsearch-modal@^5 typesense-docsearch-sidepanel@^5 typesense-docsearch-css@^5
```
...
```bash
bun add typesense-docsearch-core@^5 typesense-docsearch-modal@^5 typesense-docsearch-sidepanel@^5 typesense-docsearch-css@^5
```
...
```bash
npm install typesense-docsearch.js@^5 typesense-docsearch-sidepanel-js@^5 typesense-docsearch-css@^5
```
...
```bash
yarn add typesense-docsearch.js@^5 typesense-docsearch-sidepanel-js@^5 typesense-docsearch-css@^5
```
...
```bash
pnpm add typesense-docsearch.js@^5 typesense-docsearch-sidepanel-js@^5 typesense-docsearch-css@^5
```
...
```bash
bun add typesense-docsearch.js@^5 typesense-docsearch-sidepanel-js@^5 typesense-docsearch-css@^5
```
...
The root `typesense-docsearch.js` export includes Ask AI. The keyword-only JavaScript entry point is `typesense-docsearch.js/docsearch`; don't use that entry point for hybrid mode because it has no Ask AI action to intercept.
...
Hybrid mode is supported through `typesense-docsearch-docusaurus-adapter`. The adapter loads the v5 modal and Sidepanel, connects their state, and applies the mobile behavior described in this guide.
...
```bash
npm install typesense-docsearch-docusaurus-adapter@^5
```
...
```bash
yarn add typesense-docsearch-docusaurus-adapter@^5
```
...
```bash
pnpm add typesense-docsearch-docusaurus-adapter@^5
```
...
```bash
bun add typesense-docsearch-docusaurus-adapter@^5
```
...
If your bundler resolves the React style entry points, `typesense-docsearch-react/style` and `typesense-docsearch-react/style/sidepanel` load the same bundles. Import each bundle once.
...
Use `themeConfig.docsearch`, pass `askAi` as an object, and put `sidePanel` beside `askAi`. Install `typesense-docsearch-docusaurus-adapter@^5` instead of configuring hybrid mode through the built-in Algolia theme.
